...
static void test_input_cells_have_value(void)
{
   ...
   cell_t *input = create_input_cell(r, 10);
...
static void test_input_cells_value_can_be_set(void)
{
   ...
   reactor_t *r = create_reactor();
   cell_t *input = create_input_cell(r, 4);
...
static void test_compute_cells_calculate_initial_value(void)
{
   // TEST_IGNORE();
   reactor_t *r = create_reactor();
   cell_t *input = create_input_cell(r, 1);
   cell_t *output = create_compute1_cell(r, input, plus1);
...
static void test_compute_cells_take_inputs_in_the_right_order(void)
{
   // TEST_IGNORE();
   reactor_t *r = create_reactor();
   cell_t *one = create_input_cell(r, 1);
   cell_t *two = create_input_cell(r, 2);
   cell_t *output = create_compute2_cell(r, one, two, concat_digits);
...
static void test_compute_cells_can_depend_on_other_compute_cells(void)
{
   ...
   reactor_t *r = create_reactor();
   cell_t *input = create_input_cell(r, 1);
   cell_t *times_two = create_compute1_cell(r, input, times2);
   cell_t *times_thirty = create_compute1_cell(r, input, times30);
   cell_t *output = create_compute2_cell(r, times_two, times_thirty, plus);
...
static void test_callbacks_only_fire_on_change(void)
{
   ...
   reactor_t *r = create_reactor();
   cell_t *input = create_input_cell(r, 1);
   cell_t *output = create_compute1_cell(r, input, big_if_three);
...
static void test_callbacks_can_fire_from_multiple_cells(void)
{
   ...
   reactor_t *r = create_reactor();
   cell_t *input = create_input_cell(r, 1);
   cell_t *plus_one = create_compute1_cell(r, input, plus1);
   cell_t *minus_one = create_compute1_cell(r, input, minus1);
...
static void test_callbacks_can_be_added_and_removed(void)
{
   // TEST_IGNORE();
   reactor_t *r = create_reactor();
   cell_t *input = create_input_cell(r, 11);
   cell_t *output = create_compute1_cell(r, input, plus1);
...
test_callbacks_only_called_once_even_if_multiple_dependencies_change(void)
{
   ...
   cell_t *input = create_input_cell(r, 1);
   cell_t *plus_one = create_compute1_cell(r, input, plus1);
   cell_t *minus_one1 = create_compute1_cell(r, input, minus1);
   cell_t *minus_one2 = create_compute1_cell(r, minus_one1, minus1);
   cell_t *output = create_compute2_cell(r, plus_one, minus_one2, times);
